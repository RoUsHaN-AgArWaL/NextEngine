...
const downloadManager = {
  ...
  openManagerButton: document.getElementById('download-open-manager-button'),
  ...
  initialize: function () {
    downloadManager.openManagerButton.addEventListener('click', function () {
      ipc.send('addTab', { url: 'min://app/pages/downloads/download.html' })
    })
